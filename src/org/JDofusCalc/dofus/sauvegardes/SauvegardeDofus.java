...
/**
 * Classe représentant une sauvegarde d'un Dofus.
 * 
 * @author PAPAYA Alexandre
 * @category Dofus
 * @version 1.0
 */
public class SauvegardeDofus extends Dofus
{
	/*
	...
	/**
	 * Construit une nouvelle sauvegarde d'un Dofus.
	 * 
	 * @param nom - Nom du Dofus.
	 * @category Constructeur
	 */
	public SauvegardeDofus(String nom)
	{
		super(nom);
	}
	...
	/**
	 * Renvoie les effets du Dofus.
	 * 
	 * @return Les effets du Dofus.
	 * @category Accesseur
	 */
	...
	/**
	 * Renvoie l'index du Dofus.
	 * 
	 * @return L'index du Dofus.
	 * @category Accesseur
	 */
	...
	/**
	 * Définit les effets du Dofus.
	 * 
	 * @param effets - Les effets du Dofus.
	 * @category Accesseur
	 */
	...
	/**
	 * Définit l'index du Dofus.
	 * 
	 * @param index - L'index du Dofus.
	 * @category Accesseur
	 */
