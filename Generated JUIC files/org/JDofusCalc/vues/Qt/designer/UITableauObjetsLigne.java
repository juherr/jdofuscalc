/********************************************************************************
** Form generated from reading ui file 'UITableauObjetsLigne.jui'
**
...
public class UITableauObjetsLigne implements com.trolltech.qt.QUiForm<QWidget>
{
    public QAction actionRetirer;
    public QAction actionEquiper;
    public QAction actionGerer;
    public QHBoxLayout horizontalLayout_2;
    public QPushButton btnActions;
    public QFrame frame;
    ...
    public QLabel imgEtat;

    public UITableauObjetsLigne() { super(); }

    public void setupUi(QWidget UITableauObjetsLigne)
    {
        UITableauObjetsLigne.setObjectName("UITableauObjetsLigne");
        UITableauObjetsLigne.resize(new QSize(807, 24).expandedTo(UITableauObjetsLigne.minimumSizeHint()));
        actionRetirer = new QAction(UITableauObjetsLigne);
        actionRetirer.setObjectName("actionRetirer");
        actionRetirer.setEnabled(false);
        actionEquiper = new QAction(UITableauObjetsLigne);
        actionEquiper.setObjectName("actionEquiper");
        actionEquiper.setEnabled(false);
        actionGerer = new QAction(UITableauObjetsLigne);
        actionGerer.setObjectName("actionGerer");
        horizontalLayout_2 = new QHBoxLayout(UITableauObjetsLigne);
        horizontalLayout_2.setSpacing(0);
        horizontalLayout_2.setMargin(0);
        horizontalLayout_2.setObjectName("horizontalLayout_2");
        btnActions = new QPushButton(UITableauObjetsLigne);
        btnActions.setObjectName("btnActions");
        btnActions.setMinimumSize(new QSize(15, 15));
        btnActions.setMaximumSize(new QSize(15, 15));
        btnActions.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);
        btnActions.setIcon(new QIcon(new QPixmap("classpath:org/JDofusCalc/ressources/images/downarrow.png")));
        btnActions.setIconSize(new QSize(8, 8));

        horizontalLayout_2.addWidget(btnActions);

        frame = new QFrame(UITableauObjetsLigne);
...
"border: 1px solid black;");
        ...
        imgEtat = new QLabel(UITableauObjetsLigne);
        imgEtat.setObjectName("imgEtat");
        ...
        sizePolicy38.setHeightForWidth(imgEtat.sizePolicy().hasHeightForWidth());
        imgEtat.setSizePolicy(sizePolicy38);
        imgEtat.setMinimumSize(new QSize(24, 24));
        imgEtat.setMaximumSize(new QSize(24, 24));

        horizontalLayout_2.addWidget(imgEtat);

        retranslateUi(UITableauObjetsLigne);

        UITableauObjetsLigne.connectSlotsByName();
    } // setupUi

    void retranslateUi(QWidget UITableauObjetsLigne)
    {
        UITableauObjetsLigne.setProperty("nomObjet", "");
        actionRetirer.setText(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Retirer", null));
        actionEquiper.setText(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Equiper", null));
        actionGerer.setText(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Gerer", null));
        btnActions.setText("");
        lblStatsPA.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Points d'action", null));
        lblStatsPA.setText("");
        lblStatsPM.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Points de mouvement", null));
        lblStatsPM.setText("");
        lblStatsPO.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Bonus de Port\u00e9e", null));
        lblStatsPO.setText("");
        lblStatsIni.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Initiative", null));
        lblStatsIni.setText("");
        lblStatsPP.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Prospection", null));
        lblStatsPP.setText("");
        lblStatsVie.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Vie totale", null));
        lblStatsVie.setText("");
        lblStatsSag.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Sagesse", null));
        lblStatsSag.setText("");
        lblStatsChance.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Chance", null));
        lblStatsChance.setText("");
        lblStatsForce.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Force", null));
        lblStatsForce.setText("");
        lblStatsInt.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Intelligence", null));
        lblStatsInt.setText("");
        lblStatsAgi.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Agilit\u00e9", null));
        lblStatsAgi.setText("");
        lblStatsVita.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Vitalit\u00e9", null));
        lblStatsVita.setText("");
        lblStatsPDom.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% Dommages", null));
        lblStatsPDom.setText("");
        lblStatsInvoc.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Cr\u00e9atures invocables", null));
        lblStatsInvoc.setText("");
        lblStatsCC.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Bonus Coups Critiques", null));
        lblStatsCC.setText("");
        lblStatsSoin.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Soins", null));
        lblStatsSoin.setText("");
        lblStatsDomPiege.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Dommages aux pi\u00e8ges", null));
        lblStatsDomPiege.setText("");
        lblStatsPDomPiege.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% Dommages aux pi\u00e8ges", null));
        lblStatsPDomPiege.setText("");
        lblStatsEC.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Malus aux \u00e9checs critiques", null));
        lblStatsEC.setText("");
        lblStatsRenvois.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Revois", null));
        lblStatsRenvois.setText("");
        lblStatsDom.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "Dommages", null));
        lblStatsDom.setText("");
        lblStatsResMagique.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Magique", null));
        lblStatsResMagique.setText("");
        lblStatsResPhysique.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance physique", null));
        lblStatsResPhysique.setText("");
        lblStatsResNeutre.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Neutre", null));
        lblStatsResNeutre.setText("");
        lblStatsPResNeutre.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% R\u00e9sistance Neutre", null));
        lblStatsPResNeutre.setText("");
        lblStatsResTerre.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Terre", null));
        lblStatsResTerre.setText("");
        lblStatsPResTerre.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% R\u00e9sistance Terre", null));
        lblStatsPResTerre.setText("");
        lblStatsResFeu.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Feu", null));
        lblStatsResFeu.setText("");
        lblStatsPResFeu.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% R\u00e9sistance Feu", null));
        lblStatsPResFeu.setText("");
        lblStatsResEau.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Eau", null));
        lblStatsResEau.setText("");
        lblStatsPResEau.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% R\u00e9sistance Eau", null));
        lblStatsPResEau.setText("");
        lblStatsResAir.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "R\u00e9sistance Air", null));
        lblStatsResAir.setText("");
        lblStatsPResAir.setStatusTip(com.trolltech.qt.core.QCoreApplication.translate("UITableauObjetsLigne", "% R\u00e9sistance Air", null));
