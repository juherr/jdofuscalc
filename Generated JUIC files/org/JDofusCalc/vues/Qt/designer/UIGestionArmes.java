/********************************************************************************
** Form generated from reading ui file 'UIGestionArmes.jui'
**
...
public class UIGestionArmes implements com.trolltech.qt.QUiForm<QWidget>
{
    ...
    public QWidget ongletDegats;
    public QGridLayout gridLayout_15;
    public QLabel lblNautreDegats;
    public QLabel lblMin;
    public QLabel lblMax;
    public QLabel lblType;
    public QFrame frameCaracteristiques;
    public QGridLayout gridLayout_14;
    public QLabel lblIcoCC;
    public QLabel lblProbaCC;
    public QLabel lblDomCC;
    public QLabel lblIcoEC;
    public QLabel lblPobaEC;
    public QLabel lblIcoPA;
    public QLabel lvlCoutPA;
    public QLineEdit txtCC;
    public QLineEdit txtDomCC;
    public QLineEdit txtEC;
    public QLineEdit txtPA;
    public QLabel label;
    public QLabel lblDegatsLigne1;
    public QComboBox comboNatureDegatsL1;
    public QLineEdit txtMinL1;
    public QLineEdit txtMaxL1;
    public QComboBox comboTypeL1;
    public QPushButton btnFM;
    public QSpacerItem horizontalSpacer_3;
    public QSpacerItem horizontalSpacer_2;
    public QCheckBox cboxL2;
    public QLabel lblDegatsLigne2;
    public QComboBox comboNatureDegatsL2;
    public QLineEdit txtMinL2;
    public QLineEdit txtMaxL2;
    public QComboBox comboTypeL2;
    public QCheckBox cboxL3;
    public QLabel lblDegatsLigne3;
    public QComboBox comboNatureDegatsL3;
    public QLineEdit txtMinL3;
    public QLineEdit txtMaxL3;
    public QComboBox comboTypeL3;
    public QCheckBox cboxL4;
    public QLabel lblDegatsLigne4;
    public QComboBox comboNatureDegatsL4;
    public QLineEdit txtMinL4;
    public QLineEdit txtMaxL4;
    public QComboBox comboTypeL4;
    public QCheckBox cboxL5;
    public QLabel lblDegatsLigne5;
    public QComboBox comboNatureDegatsL5;
    public QLineEdit txtMinL5;
    public QLineEdit txtMaxL5;
    public QComboBox comboTypeL5;
    public QWidget ongletsConditions;
    public QGridLayout gridLayout;
    public QWidgetConditions widgetConditions;

    public UIGestionArmes() { super(); }

    public void setupUi(QWidget UIGestionArmes)
    {
        UIGestionArmes.setObjectName("UIGestionArmes");
        UIGestionArmes.resize(new QSize(730, 401).expandedTo(UIGestionArmes.minimumSizeHint()));
        gridLayout_11 = new QGridLayout(UIGestionArmes);
        gridLayout_11.setObjectName("gridLayout_11");
        grpModele = new QGroupBox(UIGestionArmes);
        ...
        gridLayout_12.addWidget(comboModele, 0, 1, 1, 2);
        ...
        btnChargerModele.setIcon(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/fileopen.png")));
        btnChargerModele.setIconSize(new QSize(24, 24));

        gridLayout_12.addWidget(btnChargerModele, 0, 3, 1, 2);

        frameJets = new QFrame(grpModele);
        frameJets.setObjectName("frameJets");
        frameJets.setFrameShape(com.trolltech.qt.gui.QFrame.Shape.StyledPanel);
        frameJets.setFrameShadow(com.trolltech.qt.gui.QFrame.Shadow.Raised);
        horizontalLayout_2 = new QHBoxLayout(frameJets);
        horizontalLayout_2.setSpacing(1);
        horizontalLayout_2.setMargin(1);
        horizontalLayout_2.setObjectName("horizontalLayout_2");
        rbtnMini = new QRadioButton(frameJets);
        ...
        rbtnMoy = new QRadioButton(frameJets);
        ...
        rbtnMaxi = new QRadioButton(frameJets);
        ...
        gridLayout_12.addWidget(frameJets, 1, 0, 1, 5);
        ...
        gridLayout_11.addWidget(grpModele, 0, 2, 1, 1);

        frameListe = new QFrame(UIGestionArmes);
        ...
        listeSauvegardes = new QListWidget(frameListe);
        ...
        verticalLayout_5.addWidget(listeSauvegardes);


        gridLayout_11.addWidget(frameListe, 0, 1, 6, 1);

        frameActions = new QFrame(UIGestionArmes);
        ...
        btnNouveau.setIcon(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/filenew.png")));
        ...
        gridLayout_11.addWidget(frameActions, 6, 1, 1, 3);

        onglets = new QTabWidget(UIGestionArmes);
...
"}");
        ...
        onglets.addTab(ongletCaract, com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Caract\u00e9ristiques", null));
        ongletDegats = new QWidget();
        ongletDegats.setObjectName("ongletDegats");
        gridLayout_15 = new QGridLayout(ongletDegats);
        gridLayout_15.setObjectName("gridLayout_15");
        lblNautreDegats = new QLabel(ongletDegats);
        lblNautreDegats.setObjectName("lblNautreDegats");
        lblNautreDegats.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_15.addWidget(lblNautreDegats, 0, 2, 1, 1);

        lblMin = new QLabel(ongletDegats);
        lblMin.setObjectName("lblMin");
        lblMin.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_15.addWidget(lblMin, 0, 3, 1, 1);

        lblMax = new QLabel(ongletDegats);
        lblMax.setObjectName("lblMax");
        lblMax.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_15.addWidget(lblMax, 0, 4, 1, 1);

        lblType = new QLabel(ongletDegats);
        lblType.setObjectName("lblType");
        lblType.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_15.addWidget(lblType, 0, 5, 1, 1);

        frameCaracteristiques = new QFrame(ongletDegats);
        frameCaracteristiques.setObjectName("frameCaracteristiques");
        QSizePolicy sizePolicy90 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy90.setHorizontalStretch((byte)0);
        sizePolicy90.setVerticalStretch((byte)0);
        sizePolicy90.setHeightForWidth(frameCaracteristiques.sizePolicy().hasHeightForWidth());
        frameCaracteristiques.setSizePolicy(sizePolicy90);
        frameCaracteristiques.setFrameShape(com.trolltech.qt.gui.QFrame.Shape.Box);
        frameCaracteristiques.setFrameShadow(com.trolltech.qt.gui.QFrame.Shadow.Sunken);
        gridLayout_14 = new QGridLayout(frameCaracteristiques);
        gridLayout_14.setObjectName("gridLayout_14");
        lblIcoCC = new QLabel(frameCaracteristiques);
        lblIcoCC.setObjectName("lblIcoCC");
        lblIcoCC.setPixmap(new QPixmap(("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/icoCritique.png")));

        gridLayout_14.addWidget(lblIcoCC, 0, 0, 2, 1);

        lblProbaCC = new QLabel(frameCaracteristiques);
        lblProbaCC.setObjectName("lblProbaCC");
        lblProbaCC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(lblProbaCC, 0, 1, 1, 1);

        lblDomCC = new QLabel(frameCaracteristiques);
        lblDomCC.setObjectName("lblDomCC");
        lblDomCC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(lblDomCC, 1, 1, 1, 1);

        lblIcoEC = new QLabel(frameCaracteristiques);
        lblIcoEC.setObjectName("lblIcoEC");
        lblIcoEC.setPixmap(new QPixmap(("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/icoEchec.png")));

        gridLayout_14.addWidget(lblIcoEC, 2, 0, 1, 1);

        lblPobaEC = new QLabel(frameCaracteristiques);
        lblPobaEC.setObjectName("lblPobaEC");
        lblPobaEC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(lblPobaEC, 2, 1, 1, 1);

        lblIcoPA = new QLabel(frameCaracteristiques);
        lblIcoPA.setObjectName("lblIcoPA");
        lblIcoPA.setPixmap(new QPixmap(("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/pa.png")));

        gridLayout_14.addWidget(lblIcoPA, 3, 0, 1, 1);

        lvlCoutPA = new QLabel(frameCaracteristiques);
        lvlCoutPA.setObjectName("lvlCoutPA");
        lvlCoutPA.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(lvlCoutPA, 3, 1, 1, 1);

        txtCC = new QLineEdit(frameCaracteristiques);
        txtCC.setObjectName("txtCC");
        QSizePolicy sizePolicy91 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy91.setHorizontalStretch((byte)0);
        sizePolicy91.setVerticalStretch((byte)0);
        sizePolicy91.setHeightForWidth(txtCC.sizePolicy().hasHeightForWidth());
        txtCC.setSizePolicy(sizePolicy91);
        txtCC.setMaximumSize(new QSize(40, 16777215));
        txtCC.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);
        txtCC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(txtCC, 0, 2, 1, 1);

        txtDomCC = new QLineEdit(frameCaracteristiques);
        txtDomCC.setObjectName("txtDomCC");
        QSizePolicy sizePolicy92 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy92.setHorizontalStretch((byte)0);
        sizePolicy92.setVerticalStretch((byte)0);
        sizePolicy92.setHeightForWidth(txtDomCC.sizePolicy().hasHeightForWidth());
        txtDomCC.setSizePolicy(sizePolicy92);
        txtDomCC.setMaximumSize(new QSize(40, 16777215));
        txtDomCC.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);
        txtDomCC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(txtDomCC, 1, 2, 1, 1);

        txtEC = new QLineEdit(frameCaracteristiques);
        txtEC.setObjectName("txtEC");
        QSizePolicy sizePolicy93 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy93.setHorizontalStretch((byte)0);
        sizePolicy93.setVerticalStretch((byte)0);
        sizePolicy93.setHeightForWidth(txtEC.sizePolicy().hasHeightForWidth());
        txtEC.setSizePolicy(sizePolicy93);
        txtEC.setMaximumSize(new QSize(40, 16777215));
        txtEC.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);
        txtEC.setAlignment(com.trolltech.qt.core.Qt.AlignmentFlag.createQFlags(com.trolltech.qt.core.Qt.AlignmentFlag.AlignCenter));

        gridLayout_14.addWidget(txtEC, 2, 2, 1, 1);

        txtPA = new QLineEdit(frameCaracteristiques);
        txtPA.setObjectName("txtPA");
        QSizePolicy sizePolicy94 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy94.setHorizontalStretch((byte)0);
        sizePolicy94.setVerticalStretch((byte)0);
        sizePolicy94.setHeightForWidth(txtPA.sizePolicy().hasHeightForWidth());
        txtPA.setSizePolicy(sizePolicy94);
        txtPA.setMaximumSize(new QSize(40, 16777215));
        ...
        gridLayout_14.addWidget(txtPA, 3, 2, 1, 1);

        label = new QLabel(frameCaracteristiques);
        label.setObjectName("label");
        QFont font34 = new QFont();
        font34.setPointSize(7);
        font34.setBold(true);
        font34.setUnderline(true);
        font34.setWeight(75);
        label.setFont(font34);
        ...
        gridLayout_14.addWidget(label, 4, 0, 1, 3);


        gridLayout_15.addWidget(frameCaracteristiques, 0, 8, 6, 1);

        lblDegatsLigne1 = new QLabel(ongletDegats);
        lblDegatsLigne1.setObjectName("lblDegatsLigne1");

        gridLayout_15.addWidget(lblDegatsLigne1, 1, 1, 1, 1);

        comboNatureDegatsL1 = new QComboBox(ongletDegats);
        comboNatureDegatsL1.setObjectName("comboNatureDegatsL1");
        QSizePolicy sizePolicy95 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy95.setHorizontalStretch((byte)0);
        sizePolicy95.setVerticalStretch((byte)0);
        sizePolicy95.setHeightForWidth(comboNatureDegatsL1.sizePolicy().hasHeightForWidth());
        comboNatureDegatsL1.setSizePolicy(sizePolicy95);
        comboNatureDegatsL1.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboNatureDegatsL1, 1, 2, 1, 1);

        txtMinL1 = new QLineEdit(ongletDegats);
        txtMinL1.setObjectName("txtMinL1");
        txtMinL1.setMinimumSize(new QSize(30, 0));
        txtMinL1.setMaximumSize(new QSize(30, 16777215));
        txtMinL1.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMinL1, 1, 3, 1, 1);

        txtMaxL1 = new QLineEdit(ongletDegats);
        txtMaxL1.setObjectName("txtMaxL1");
        txtMaxL1.setMinimumSize(new QSize(30, 0));
        txtMaxL1.setMaximumSize(new QSize(30, 16777215));
        txtMaxL1.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMaxL1, 1, 4, 1, 1);

        comboTypeL1 = new QComboBox(ongletDegats);
        comboTypeL1.setObjectName("comboTypeL1");
        ...
        sizePolicy96.setHeightForWidth(comboTypeL1.sizePolicy().hasHeightForWidth());
        comboTypeL1.setSizePolicy(sizePolicy96);
        comboTypeL1.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboTypeL1, 1, 5, 1, 1);

        btnFM = new QPushButton(ongletDegats);
        btnFM.setObjectName("btnFM");
        QSizePolicy sizePolicy97 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Fixed, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy97.setHorizontalStretch((byte)0);
        sizePolicy97.setVerticalStretch((byte)0);
        sizePolicy97.setHeightForWidth(btnFM.sizePolicy().hasHeightForWidth());
        btnFM.setSizePolicy(sizePolicy97);
        btnFM.setMinimumSize(new QSize(30, 0));
        btnFM.setMaximumSize(new QSize(30, 16777215));
        btnFM.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);
        btnFM.setStyleSheet("font: 7pt \"MS Shell Dlg 2\";");

        gridLayout_15.addWidget(btnFM, 1, 6, 1, 1);
        ...
        gridLayout_15.addItem(horizontalSpacer_3, 1, 7, 1, 1);

        horizontalSpacer_2 = new QSpacerItem(0, 0, com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Minimum);

        gridLayout_15.addItem(horizontalSpacer_2, 1, 9, 1, 1);

        cboxL2 = new QCheckBox(ongletDegats);
        cboxL2.setObjectName("cboxL2");
        cboxL2.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(cboxL2, 2, 0, 1, 1);

        lblDegatsLigne2 = new QLabel(ongletDegats);
        lblDegatsLigne2.setObjectName("lblDegatsLigne2");
        lblDegatsLigne2.setEnabled(false);

        gridLayout_15.addWidget(lblDegatsLigne2, 2, 1, 1, 1);

        comboNatureDegatsL2 = new QComboBox(ongletDegats);
        comboNatureDegatsL2.setObjectName("comboNatureDegatsL2");
        comboNatureDegatsL2.setEnabled(false);
        QSizePolicy sizePolicy98 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy98.setHorizontalStretch((byte)0);
        sizePolicy98.setVerticalStretch((byte)0);
        sizePolicy98.setHeightForWidth(comboNatureDegatsL2.sizePolicy().hasHeightForWidth());
        comboNatureDegatsL2.setSizePolicy(sizePolicy98);
        comboNatureDegatsL2.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboNatureDegatsL2, 2, 2, 1, 1);

        txtMinL2 = new QLineEdit(ongletDegats);
        txtMinL2.setObjectName("txtMinL2");
        txtMinL2.setEnabled(false);
        txtMinL2.setMinimumSize(new QSize(30, 0));
        txtMinL2.setMaximumSize(new QSize(30, 16777215));
        txtMinL2.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMinL2, 2, 3, 1, 1);

        txtMaxL2 = new QLineEdit(ongletDegats);
        txtMaxL2.setObjectName("txtMaxL2");
        txtMaxL2.setEnabled(false);
        txtMaxL2.setMinimumSize(new QSize(30, 0));
        txtMaxL2.setMaximumSize(new QSize(30, 16777215));
        txtMaxL2.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMaxL2, 2, 4, 1, 1);

        comboTypeL2 = new QComboBox(ongletDegats);
        comboTypeL2.setObjectName("comboTypeL2");
        comboTypeL2.setEnabled(false);
        QSizePolicy sizePolicy99 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy99.setHorizontalStretch((byte)0);
        sizePolicy99.setVerticalStretch((byte)0);
        sizePolicy99.setHeightForWidth(comboTypeL2.sizePolicy().hasHeightForWidth());
        comboTypeL2.setSizePolicy(sizePolicy99);
        comboTypeL2.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboTypeL2, 2, 5, 1, 1);

        cboxL3 = new QCheckBox(ongletDegats);
        cboxL3.setObjectName("cboxL3");
        cboxL3.setEnabled(false);
        cboxL3.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(cboxL3, 3, 0, 1, 1);

        lblDegatsLigne3 = new QLabel(ongletDegats);
        lblDegatsLigne3.setObjectName("lblDegatsLigne3");
        lblDegatsLigne3.setEnabled(false);

        gridLayout_15.addWidget(lblDegatsLigne3, 3, 1, 1, 1);

        comboNatureDegatsL3 = new QComboBox(ongletDegats);
        comboNatureDegatsL3.setObjectName("comboNatureDegatsL3");
        comboNatureDegatsL3.setEnabled(false);
        ...
        sizePolicy100.setHeightForWidth(comboNatureDegatsL3.sizePolicy().hasHeightForWidth());
        comboNatureDegatsL3.setSizePolicy(sizePolicy100);
        comboNatureDegatsL3.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboNatureDegatsL3, 3, 2, 1, 1);

        txtMinL3 = new QLineEdit(ongletDegats);
        txtMinL3.setObjectName("txtMinL3");
        txtMinL3.setEnabled(false);
        txtMinL3.setMinimumSize(new QSize(30, 0));
        txtMinL3.setMaximumSize(new QSize(30, 16777215));
        txtMinL3.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMinL3, 3, 3, 1, 1);

        txtMaxL3 = new QLineEdit(ongletDegats);
        txtMaxL3.setObjectName("txtMaxL3");
        txtMaxL3.setEnabled(false);
        txtMaxL3.setMinimumSize(new QSize(30, 0));
        txtMaxL3.setMaximumSize(new QSize(30, 16777215));
        txtMaxL3.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMaxL3, 3, 4, 1, 1);

        comboTypeL3 = new QComboBox(ongletDegats);
        comboTypeL3.setObjectName("comboTypeL3");
        comboTypeL3.setEnabled(false);
        QSizePolicy sizePolicy101 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy101.setHorizontalStretch((byte)0);
        sizePolicy101.setVerticalStretch((byte)0);
        sizePolicy101.setHeightForWidth(comboTypeL3.sizePolicy().hasHeightForWidth());
        comboTypeL3.setSizePolicy(sizePolicy101);
        comboTypeL3.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboTypeL3, 3, 5, 1, 1);

        cboxL4 = new QCheckBox(ongletDegats);
        cboxL4.setObjectName("cboxL4");
        cboxL4.setEnabled(false);
        cboxL4.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(cboxL4, 4, 0, 1, 1);

        lblDegatsLigne4 = new QLabel(ongletDegats);
        lblDegatsLigne4.setObjectName("lblDegatsLigne4");
        lblDegatsLigne4.setEnabled(false);

        gridLayout_15.addWidget(lblDegatsLigne4, 4, 1, 1, 1);

        comboNatureDegatsL4 = new QComboBox(ongletDegats);
        comboNatureDegatsL4.setObjectName("comboNatureDegatsL4");
        comboNatureDegatsL4.setEnabled(false);
        QSizePolicy sizePolicy102 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy102.setHorizontalStretch((byte)0);
        sizePolicy102.setVerticalStretch((byte)0);
        sizePolicy102.setHeightForWidth(comboNatureDegatsL4.sizePolicy().hasHeightForWidth());
        comboNatureDegatsL4.setSizePolicy(sizePolicy102);
        comboNatureDegatsL4.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboNatureDegatsL4, 4, 2, 1, 1);

        txtMinL4 = new QLineEdit(ongletDegats);
        txtMinL4.setObjectName("txtMinL4");
        txtMinL4.setEnabled(false);
        txtMinL4.setMinimumSize(new QSize(30, 0));
        txtMinL4.setMaximumSize(new QSize(30, 16777215));
        txtMinL4.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMinL4, 4, 3, 1, 1);

        txtMaxL4 = new QLineEdit(ongletDegats);
        txtMaxL4.setObjectName("txtMaxL4");
        txtMaxL4.setEnabled(false);
        txtMaxL4.setMinimumSize(new QSize(30, 0));
        txtMaxL4.setMaximumSize(new QSize(30, 16777215));
        txtMaxL4.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMaxL4, 4, 4, 1, 1);

        comboTypeL4 = new QComboBox(ongletDegats);
        comboTypeL4.setObjectName("comboTypeL4");
        comboTypeL4.setEnabled(false);
        QSizePolicy sizePolicy103 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy103.setHorizontalStretch((byte)0);
        sizePolicy103.setVerticalStretch((byte)0);
        sizePolicy103.setHeightForWidth(comboTypeL4.sizePolicy().hasHeightForWidth());
        comboTypeL4.setSizePolicy(sizePolicy103);
        comboTypeL4.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboTypeL4, 4, 5, 1, 1);

        cboxL5 = new QCheckBox(ongletDegats);
        cboxL5.setObjectName("cboxL5");
        cboxL5.setEnabled(false);
        cboxL5.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(cboxL5, 5, 0, 1, 1);

        lblDegatsLigne5 = new QLabel(ongletDegats);
        lblDegatsLigne5.setObjectName("lblDegatsLigne5");
        lblDegatsLigne5.setEnabled(false);

        gridLayout_15.addWidget(lblDegatsLigne5, 5, 1, 1, 1);

        comboNatureDegatsL5 = new QComboBox(ongletDegats);
        comboNatureDegatsL5.setObjectName("comboNatureDegatsL5");
        comboNatureDegatsL5.setEnabled(false);
        ...
        sizePolicy104.setHeightForWidth(comboNatureDegatsL5.sizePolicy().hasHeightForWidth());
        comboNatureDegatsL5.setSizePolicy(sizePolicy104);
        comboNatureDegatsL5.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboNatureDegatsL5, 5, 2, 1, 1);

        txtMinL5 = new QLineEdit(ongletDegats);
        txtMinL5.setObjectName("txtMinL5");
        txtMinL5.setEnabled(false);
        txtMinL5.setMinimumSize(new QSize(30, 0));
        txtMinL5.setMaximumSize(new QSize(30, 16777215));
        txtMinL5.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMinL5, 5, 3, 1, 1);

        txtMaxL5 = new QLineEdit(ongletDegats);
        txtMaxL5.setObjectName("txtMaxL5");
        txtMaxL5.setEnabled(false);
        txtMaxL5.setMinimumSize(new QSize(30, 0));
        txtMaxL5.setMaximumSize(new QSize(30, 16777215));
        txtMaxL5.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_15.addWidget(txtMaxL5, 5, 4, 1, 1);

        comboTypeL5 = new QComboBox(ongletDegats);
        comboTypeL5.setObjectName("comboTypeL5");
        comboTypeL5.setEnabled(false);
        QSizePolicy sizePolicy105 = new QSizePolicy(com.trolltech.qt.gui.QSizePolicy.Policy.Expanding, com.trolltech.qt.gui.QSizePolicy.Policy.Fixed);
        sizePolicy105.setHorizontalStretch((byte)0);
        sizePolicy105.setVerticalStretch((byte)0);
        sizePolicy105.setHeightForWidth(comboTypeL5.sizePolicy().hasHeightForWidth());
        comboTypeL5.setSizePolicy(sizePolicy105);
        comboTypeL5.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        gridLayout_15.addWidget(comboTypeL5, 5, 5, 1, 1);

        onglets.addTab(ongletDegats, com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "D\u00e9g\u00e2ts", null));
        ongletsConditions = new QWidget();
        ongletsConditions.setObjectName("ongletsConditions");
        gridLayout = new QGridLayout(ongletsConditions);
        gridLayout.setObjectName("gridLayout");
        widgetConditions = new QWidgetConditions(ongletsConditions);
        widgetConditions.setObjectName("widgetConditions");

        gridLayout.addWidget(widgetConditions, 0, 0, 1, 1);

        onglets.addTab(ongletsConditions, com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Conditions", null));

        gridLayout_11.addWidget(onglets, 1, 2, 1, 1);
        ...
        QWidget.setTabOrder(btnChargerModele, btnSauv);
        QWidget.setTabOrder(btnSauv, btnFermer);
        retranslateUi(UIGestionArmes);
        btnFermer.clicked.connect(UIGestionArmes, "close()");

        onglets.setCurrentIndex(0);
        comboNatureDegatsL1.setCurrentIndex(0);


        UIGestionArmes.connectSlotsByName();
    } // setupUi

    void retranslateUi(QWidget UIGestionArmes)
    {
        UIGestionArmes.setWindowTitle(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Gestion", null));
        grpModele.setTitle(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Mod\u00e8le", null));
        btnChargerModele.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Charger", null));
        rbtnMini.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Jets minimums", null));
        rbtnMoy.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Jets moyens", null));
        rbtnMaxi.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Jets maximums", null));
        lblListe.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Armes enregistr\u00e9es :", null));
        btnNouveau.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Nouveau", null));
        btnSupp.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Supprimer", null));
        btnSauv.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Sauvegarder", null));
        btnFermer.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Fermer", null));
        lblStatsPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Points d'action", null));
        lblStatsPA.setText("");
        lblStatsPM.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Points de mouvement", null));
        lblStatsPM.setText("");
        lblStatsPO.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Bonus de Port\u00e9e", null));
        lblStatsPO.setText("");
        lblStatsIni.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Initiative", null));
        lblStatsIni.setText("");
        lblStatsPP.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Prospection", null));
        lblStatsPP.setText("");
        lblStatsVie.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Vie totale", null));
        lblStatsVie.setText("");
        txtStatsPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Points d'action", null));
        txtStatsPA.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9; ", null));
        txtStatsIni.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Initiative", null));
        txtStatsIni.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9999; ", null));
        txtStatsVie.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Vie totale", null));
        txtStatsVie.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9999; ", null));
        txtStatsPO.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Bonus de Port\u00e9e", null));
        txtStatsPO.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9; ", null));
        txtStatsPP.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Prospection", null));
        txtStatsPP.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPM.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Points de mouvement", null));
        txtStatsPM.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9; ", null));
        lblStatsPDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% Dommages", null));
        lblStatsPDom.setText("");
        lblStatsInvoc.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Cr\u00e9atures invocables", null));
        lblStatsInvoc.setText("");
        lblStatsCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Bonus Coups Critiques", null));
        lblStatsCC.setText("");
        lblStatsSoin.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        lblStatsSoin.setText("");
        lblStatsDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages aux pi\u00e8ges", null));
        lblStatsDomPiege.setText("");
        lblStatsPDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% Dommages aux pi\u00e8ges", null));
        lblStatsPDomPiege.setText("");
        lblStatsEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Malus aux \u00e9checs critiques", null));
        lblStatsEC.setText("");
        lblStatsRenvois.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Renvois", null));
        lblStatsRenvois.setText("");
        lblStatsDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        lblStatsDom.setText("");
        txtStatsDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages aux pi\u00e8ges", null));
        txtStatsDomPiege.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% Dommages aux pi\u00e8ges", null));
        txtStatsPDomPiege.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% Dommages", null));
        txtStatsPDom.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsSoin.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        txtStatsSoin.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Bonus Coups Critiques", null));
        txtStatsCC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Malus aux \u00e9checs critiques", null));
        txtStatsEC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsRenvois.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Renvois", null));
        txtStatsRenvois.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        txtStatsDom.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsInvoc.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Cr\u00e9atures invocables", null));
        txtStatsInvoc.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        lblStatsResMagique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Magique", null));
        lblStatsResMagique.setText("");
        lblStatsResPhysique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Physique", null));
        lblStatsResPhysique.setText("");
        lblStatsResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Neutre", null));
        lblStatsResNeutre.setText("");
        lblStatsPResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Neutre", null));
        lblStatsPResNeutre.setText("");
        lblStatsResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Terre", null));
        lblStatsResTerre.setText("");
        lblStatsPResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Terre", null));
        lblStatsPResTerre.setText("");
        lblStatsResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Feu", null));
        lblStatsResFeu.setText("");
        lblStatsPResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Feu", null));
        lblStatsPResFeu.setText("");
        lblStatsResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Eau", null));
        lblStatsResEau.setText("");
        lblStatsPResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Eau", null));
        lblStatsPResEau.setText("");
        lblStatsResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Air", null));
        lblStatsResAir.setText("");
        lblStatsPResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Air", null));
        lblStatsPResAir.setText("");
        txtStatsResMagique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Magique", null));
        txtStatsResMagique.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResPhysique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Physique", null));
        txtStatsResPhysique.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Neutre", null));
        txtStatsResNeutre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% Resistance Neutre", null));
        txtStatsPResNeutre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Terre", null));
        txtStatsResTerre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Terre", null));
        txtStatsPResTerre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Feu", null));
        txtStatsResFeu.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Feu", null));
        txtStatsPResFeu.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Eau", null));
        txtStatsResEau.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistnace Eau", null));
        txtStatsPResEau.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "R\u00e9sistance Air", null));
        txtStatsResAir.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        txtStatsPResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "% R\u00e9sistance Air", null));
        txtStatsPResAir.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#99; ", null));
        lblStatsSag.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Sagesse", null));
        lblStatsSag.setText("");
        lblStatsChance.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Chance", null));
        lblStatsChance.setText("");
        lblStatsForce.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Force", null));
        lblStatsForce.setText("");
        lblStatsInt.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Intelligence", null));
        lblStatsInt.setText("");
        lblStatsAgi.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Agilit\u00e9", null));
        lblStatsAgi.setText("");
        lblStatsVita.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Vitalit\u00e9", null));
        lblStatsVita.setText("");
        txtStatsAgi.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Agilit\u00e9", null));
        txtStatsAgi.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#999; ", null));
        txtStatsChance.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Chance", null));
        txtStatsChance.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#999; ", null));
        txtStatsInt.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Intelligence", null));
        txtStatsInt.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#999; ", null));
        txtStatsVita.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Vitalit\u00e9", null));
        txtStatsVita.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#9999; ", null));
        txtStatsSag.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Sagesse", null));
        txtStatsSag.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#999; ", null));
        txtStatsForce.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Force", null));
        txtStatsForce.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "#999; ", null));
        lblNom.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Nom", null));
        lblPano.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Panoplie :", null));
        comboPano.clear();
        comboPano.addItem(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "<G\u00e9n\u00e9r\u00e9>", null));
        lblNiveau.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Niveau :", null));
        onglets.setTabText(onglets.indexOf(ongletCaract), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Caract\u00e9ristiques", null));
        lblNautreDegats.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Nature des d\u00e9gats", null));
        lblMin.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Min", null));
        lblMax.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Max", null));
        lblType.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Type des d\u00e9gats", null));
        lblIcoCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Coups critiques", null));
        lblProbaCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Coups critiques", null));
        lblProbaCC.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "1/X", null));
        lblDomCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Coups critiques", null));
        lblDomCC.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "+D\u00e9g.", null));
        lblIcoEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Echecs critiques", null));
        lblPobaEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Echecs critiques", null));
        lblPobaEC.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "1/Y", null));
        lblIcoPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Co\u00fbt d'utilisation", null));
        lvlCoutPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Co\u00fbt d'utilisation", null));
        lvlCoutPA.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "PA", null));
        txtCC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "999; ", null));
        txtDomCC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "999; ", null));
        txtEC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "999; ", null));
        txtPA.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "999; ", null));
        label.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Informations\n"+
"obligatoires", null));
        lblDegatsLigne1.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Ligne 1 :", null));
        comboNatureDegatsL1.clear();
        comboNatureDegatsL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/dommages.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        comboNatureDegatsL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/volvie.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Voles", null));
        comboNatureDegatsL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/soins.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        comboTypeL1.clear();
        comboTypeL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsNeutre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Neutre", null));
        comboTypeL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsTerre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Terre", null));
        comboTypeL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsFeu.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Feu", null));
        comboTypeL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsEau.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Eau", null));
        comboTypeL1.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsAir.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Air", null));
        btnFM.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "FM", null));
        lblDegatsLigne2.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Ligne 2 :", null));
        comboNatureDegatsL2.clear();
        comboNatureDegatsL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/dommages.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        comboNatureDegatsL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/volvie.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Voles", null));
        comboNatureDegatsL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/soins.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        comboTypeL2.clear();
        comboTypeL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsNeutre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Neutre", null));
        comboTypeL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsTerre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Terre", null));
        comboTypeL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsFeu.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Feu", null));
        comboTypeL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsEau.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Eau", null));
        comboTypeL2.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsAir.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Air", null));
        lblDegatsLigne3.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Ligne 3 :", null));
        comboNatureDegatsL3.clear();
        comboNatureDegatsL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/dommages.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        comboNatureDegatsL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/volvie.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Voles", null));
        comboNatureDegatsL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/soins.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        comboTypeL3.clear();
        comboTypeL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsNeutre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Neutre", null));
        comboTypeL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsTerre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Terre", null));
        comboTypeL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsFeu.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Feu", null));
        comboTypeL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsEau.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Eau", null));
        comboTypeL3.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsAir.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Air", null));
        lblDegatsLigne4.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Ligne 4 :", null));
        comboNatureDegatsL4.clear();
        comboNatureDegatsL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/dommages.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        comboNatureDegatsL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/volvie.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Voles", null));
        comboNatureDegatsL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/soins.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        comboTypeL4.clear();
        comboTypeL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsNeutre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Neutre", null));
        comboTypeL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsTerre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Terre", null));
        comboTypeL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsFeu.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Feu", null));
        comboTypeL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsEau.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Eau", null));
        comboTypeL4.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsAir.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Air", null));
        lblDegatsLigne5.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Ligne 5 :", null));
        comboNatureDegatsL5.clear();
        comboNatureDegatsL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/dommages.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Dommages", null));
        comboNatureDegatsL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/volvie.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Voles", null));
        comboNatureDegatsL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/soins.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Soins", null));
        comboTypeL5.clear();
        comboTypeL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsNeutre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Neutre", null));
        comboTypeL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsTerre.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Terre", null));
        comboTypeL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsFeu.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Feu", null));
        comboTypeL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsEau.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Eau", null));
        comboTypeL5.addItem(new QIcon(new QPixmap("classpath:file:F:/Mes documents/Java/Mes projets/JDofusCalc/src#org/JDofusCalc/ressources/images/degatsAir.png")), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Air", null));
        onglets.setTabText(onglets.indexOf(ongletDegats), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "D\u00e9g\u00e2ts", null));
        onglets.setTabText(onglets.indexOf(ongletsConditions), com.trolltech.qt.core.QCoreApplication.translate("UIGestionArmes", "Conditions", null));
    } // retranslateUi
