...
/**
 * Observateur des évenements liés aux sauvegardes des équipements.
 * 
 * @author PAPAYA Alexandre
 * @category Observateur
 * @version 1.0
 */
public interface ObservateurSauvegardesEquipements extends EventListener
{
	/**
	 * Méthode invoquée lors de la sauvegarde d'un équipement.
	 * 
	 * @param typeArme - Type de l'équipement.
	...
	/**
	 * Méthode invoquée lors de la création d'un objet
	 * 
	 * @param typeArme - Type de l'équipement.
	 * @param sauvegarde - Objet sauvegarde de l'équipement. 
	 */
	...
	/**
	 * Méthode invoquée lors de la suppression d'un objet
	 * 
	 * @param typeArme - Type de l'équipement.
	 * @param sauvegarde - Objet sauvegarde de l'équipement.
	 */
