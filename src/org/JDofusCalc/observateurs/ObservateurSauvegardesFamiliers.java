...
/**
 * Observateur des evenements liés aux sauvegardes des familiers.
 * 
 * @author PAPAYA Alexandre
 * @category Observateur
 * @version 1.0
 */
public interface ObservateurSauvegardesFamiliers extends EventListener
{
	/**
	 * Méthode invoquée lors de la sauvegarde d'un familier.
	 * 
	 * @param sauvegarde
	 */
	...
	/**
	 * Méthode invoquée lors de la création d'un familier.
	 * 
	 * @param sauvegarde
	 */
	...
	/**
	 * Méthode invoquée lors de la suppression d'un familier.
	 * 
	 * @param sauvegarde
	 */
