...
/**
 * Observateur des evenements liés aux sauvegardes des Montures.
 * 
 * @author PAPAYA Alexandre
 * @category Observateur
 * @version 1.0
 */
public interface ObservateurSauvegardesMontures extends EventListener
{
	/**
	 * Méthode invoquée lors de la sauvegarde d'un Monture.
	 * 
	 * @param sauvegarde
	 */
	...
	/**
	 * Méthode invoquée lors de la création d'un Monture.
	 * 
	 * @param sauvegarde
	 */
	...
	/**
	 * Méthode invoquée lors de la suppression d'un Monture.
	 * 
	 * @param sauvegarde
	 */
