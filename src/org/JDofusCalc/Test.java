...
import org.JDofusCalc.modeles.GenerateurRequete;
...
public class Test
{
	...
	public static void main(String[] args)
	{
		...
		/*for(int i = 1; i <= 8; i++)
		{
			System.out.println("jointuresEffets.add(new String[] {\"E" + i + "\", \"BONUS_" + i + "O\"});");
		}*/
		
		/*
		String nomChamp = "BONUS_" + 2 + "O";
		...
		generateur.setWhereEgal("ID", 9);
		
		//String requeteOld = "SELECT * FROM MONTURES ORDER BY NOM ASC";
		//System.out.println(requeteOld);
			
		System.out.println(generateur.construireRequete());
		//*/
	}
}