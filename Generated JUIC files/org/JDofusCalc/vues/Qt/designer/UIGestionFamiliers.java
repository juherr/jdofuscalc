/********************************************************************************
** Form generated from reading ui file 'UIGestionFamiliers.jui'
**
...
public class UIGestionFamiliers implements com.trolltech.qt.QUiForm<QWidget>
{
    public QGridLayout gridLayout;
    public QFrame frameListe;
    public QVBoxLayout verticalLayout_5;
    public QLabel lblListe;
    public QListWidget listeFamiliers;
    ...
    public UIGestionFamiliers() { super(); }

    public void setupUi(QWidget UIGestionFamiliers)
    {
        UIGestionFamiliers.setObjectName("UIGestionFamiliers");
        UIGestionFamiliers.resize(new QSize(662, 356).expandedTo(UIGestionFamiliers.minimumSizeHint()));
        gridLayout = new QGridLayout(UIGestionFamiliers);
        gridLayout.setObjectName("gridLayout");
        frameListe = new QFrame(UIGestionFamiliers);
        ...
        listeFamiliers = new QListWidget(frameListe);
        listeFamiliers.setObjectName("listeFamiliers");
        listeFamiliers.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.WheelFocus);

        verticalLayout_5.addWidget(listeFamiliers);


        gridLayout.addWidget(frameListe, 0, 0, 2, 1);

        grpModele = new QGroupBox(UIGestionFamiliers);
        ...
        sizePolicy1.setHeightForWidth(comboModele.sizePolicy().hasHeightForWidth());
        comboModele.setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(btnChargerModele.sizePolicy().hasHeightForWidth());
        btnChargerModele.setSizePolicy(sizePolicy2);
        ...
        gridLayout_12.addWidget(btnChargerModele, 0, 2, 1, 2);
        ...
        sizePolicy3.setHeightForWidth(rbtnMini.sizePolicy().hasHeightForWidth());
        rbtnMini.setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(rbtnMoy.sizePolicy().hasHeightForWidth());
        rbtnMoy.setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(rbtnMaxi.sizePolicy().hasHeightForWidth());
        rbtnMaxi.setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(filtre.sizePolicy().hasHeightForWidth());
        filtre.setSizePolicy(sizePolicy6);

        gridLayout_12.addWidget(filtre, 0, 0, 1, 1);


        gridLayout.addWidget(grpModele, 0, 1, 1, 1);

        frameActions = new QFrame(UIGestionFamiliers);
        ...
        gridLayout.addWidget(frameActions, 2, 0, 1, 2);

        groupBox = new QGroupBox(UIGestionFamiliers);
        groupBox.setObjectName("groupBox");
        gridLayout_8 = new QGridLayout(groupBox);
        gridLayout_8.setObjectName("gridLayout_8");
        frameStats = new QFrame(groupBox);
...
"}");
        ...
        gridLayout_8.addWidget(frameStats, 1, 0, 1, 11);

        lblNom = new QLabel(groupBox);
        ...
        sizePolicy87.setHeightForWidth(lblNom.sizePolicy().hasHeightForWidth());
        lblNom.setSizePolicy(sizePolicy87);

        gridLayout_8.addWidget(lblNom, 0, 0, 1, 1);

        comboPano = new QComboBox(groupBox);
        ...
        gridLayout_8.addWidget(comboPano, 2, 9, 1, 1);

        lblPano = new QLabel(groupBox);
        lblPano.setObjectName("lblPano");

        gridLayout_8.addWidget(lblPano, 2, 8, 1, 1);

        txtNom = new QLineEdit(groupBox);
        ...
        sizePolicy89.setHeightForWidth(txtNom.sizePolicy().hasHeightForWidth());
        txtNom.setSizePolicy(sizePolicy89);
        txtNom.setFocusPolicy(com.trolltech.qt.core.Qt.FocusPolicy.StrongFocus);

        gridLayout_8.addWidget(txtNom, 0, 1, 1, 7);

        spinBoxNiveau = new QSpinBox(groupBox);
        ...
        sizePolicy90.setHeightForWidth(spinBoxNiveau.sizePolicy().hasHeightForWidth());
        spinBoxNiveau.setSizePolicy(sizePolicy90);
        ...
        gridLayout_8.addWidget(spinBoxNiveau, 2, 4, 1, 1);

        lblNiveau = new QLabel(groupBox);
        ...
        sizePolicy91.setHeightForWidth(lblNiveau.sizePolicy().hasHeightForWidth());
        lblNiveau.setSizePolicy(sizePolicy91);

        gridLayout_8.addWidget(lblNiveau, 2, 3, 1, 1);
        ...
        retranslateUi(UIGestionFamiliers);

        UIGestionFamiliers.connectSlotsByName();
    } // setupUi

    void retranslateUi(QWidget UIGestionFamiliers)
    {
        UIGestionFamiliers.setWindowTitle(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Gestion des familiers", null));
        lblListe.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Familiers enregistr\u00e9s :", null));
        grpModele.setTitle(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Mod\u00e8le", null));
        btnChargerModele.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Charger", null));
        rbtnMini.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Jets minimums", null));
        rbtnMoy.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Jets moyens", null));
        rbtnMaxi.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Jets maximums", null));
        btnNouveau.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Nouveau", null));
        btnSupp.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Supprimer", null));
        btnSauv.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Sauvegarder", null));
        btnFermer.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Fermer", null));
        groupBox.setTitle(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "GroupBox", null));
        lblStatsPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Points d'action", null));
        lblStatsPA.setText("");
        lblStatsPM.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Points de mouvement", null));
        lblStatsPM.setText("");
        lblStatsPO.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Bonus de Port\u00e9e", null));
        lblStatsPO.setText("");
        lblStatsIni.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Initiative", null));
        lblStatsIni.setText("");
        lblStatsPP.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Prospection", null));
        lblStatsPP.setText("");
        lblStatsVie.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Vie totale", null));
        lblStatsVie.setText("");
        txtStatsPA.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Points d'action", null));
        txtStatsPA.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9; ", null));
        txtStatsIni.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Initiative", null));
        txtStatsIni.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9999; ", null));
        txtStatsVie.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Vie totale", null));
        txtStatsVie.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9999; ", null));
        txtStatsPO.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Bonus de Port\u00e9e", null));
        txtStatsPO.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9; ", null));
        txtStatsPP.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Prospection", null));
        txtStatsPP.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPM.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Points de mouvement", null));
        txtStatsPM.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9; ", null));
        lblStatsPDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% Dommages", null));
        lblStatsPDom.setText("");
        lblStatsInvoc.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Cr\u00e9atures invocables", null));
        lblStatsInvoc.setText("");
        lblStatsCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Bonus Coups Critiques", null));
        lblStatsCC.setText("");
        lblStatsSoin.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Soins", null));
        lblStatsSoin.setText("");
        lblStatsDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Dommages aux pi\u00e8ges", null));
        lblStatsDomPiege.setText("");
        lblStatsPDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% Dommages aux pi\u00e8ges", null));
        lblStatsPDomPiege.setText("");
        lblStatsEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Malus aux \u00e9checs critiques", null));
        lblStatsEC.setText("");
        lblStatsRenvois.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Renvois", null));
        lblStatsRenvois.setText("");
        lblStatsDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Dommages", null));
        lblStatsDom.setText("");
        txtStatsDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Dommages aux pi\u00e8ges", null));
        txtStatsDomPiege.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPDomPiege.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% Dommages aux pi\u00e8ges", null));
        txtStatsPDomPiege.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% Dommages", null));
        txtStatsPDom.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsSoin.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Soins", null));
        txtStatsSoin.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsCC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Bonus Coups Critiques", null));
        txtStatsCC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsEC.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Malus aux \u00e9checs critiques", null));
        txtStatsEC.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsRenvois.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Renvois", null));
        txtStatsRenvois.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsDom.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Dommages", null));
        txtStatsDom.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsInvoc.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Cr\u00e9atures invocables", null));
        txtStatsInvoc.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        lblStatsResMagique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Magique", null));
        lblStatsResMagique.setText("");
        lblStatsResPhysique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Physique", null));
        lblStatsResPhysique.setText("");
        lblStatsResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Neutre", null));
        lblStatsResNeutre.setText("");
        lblStatsPResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Neutre", null));
        lblStatsPResNeutre.setText("");
        lblStatsResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Terre", null));
        lblStatsResTerre.setText("");
        lblStatsPResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Terre", null));
        lblStatsPResTerre.setText("");
        lblStatsResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Feu", null));
        lblStatsResFeu.setText("");
        lblStatsPResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Feu", null));
        lblStatsPResFeu.setText("");
        lblStatsResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Eau", null));
        lblStatsResEau.setText("");
        lblStatsPResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Eau", null));
        lblStatsPResEau.setText("");
        lblStatsResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Air", null));
        lblStatsResAir.setText("");
        lblStatsPResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Air", null));
        lblStatsPResAir.setText("");
        txtStatsResMagique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Magique", null));
        txtStatsResMagique.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResPhysique.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Physique", null));
        txtStatsResPhysique.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Neutre", null));
        txtStatsResNeutre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPResNeutre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% Resistance Neutre", null));
        txtStatsPResNeutre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Terre", null));
        txtStatsResTerre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPResTerre.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Terre", null));
        txtStatsPResTerre.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Feu", null));
        txtStatsResFeu.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPResFeu.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Feu", null));
        txtStatsPResFeu.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Eau", null));
        txtStatsResEau.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPResEau.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistnace Eau", null));
        txtStatsPResEau.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "R\u00e9sistance Air", null));
        txtStatsResAir.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        txtStatsPResAir.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "% R\u00e9sistance Air", null));
        txtStatsPResAir.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#99; ", null));
        lblStatsSag.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Sagesse", null));
        lblStatsSag.setText("");
        lblStatsChance.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Chance", null));
        lblStatsChance.setText("");
        lblStatsForce.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Force", null));
        lblStatsForce.setText("");
        lblStatsInt.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Intelligence", null));
        lblStatsInt.setText("");
        lblStatsAgi.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Agilit\u00e9", null));
        lblStatsAgi.setText("");
        lblStatsVita.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Vitalit\u00e9", null));
        lblStatsVita.setText("");
        txtStatsAgi.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Agilit\u00e9", null));
        txtStatsAgi.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#999; ", null));
        txtStatsChance.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Chance", null));
        txtStatsChance.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#999; ", null));
        txtStatsInt.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Intelligence", null));
        txtStatsInt.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#999; ", null));
        txtStatsVita.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Vitalit\u00e9", null));
        txtStatsVita.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#9999; ", null));
        txtStatsSag.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Sagesse", null));
        txtStatsSag.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#999; ", null));
        txtStatsForce.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Force", null));
        txtStatsForce.setInputMask(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "#999; ", null));
        lblNom.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Nom", null));
        comboPano.clear();
        comboPano.addItem(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "<G\u00e9n\u00e9r\u00e9>", null));
        lblPano.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Panoplie :", null));
        lblNiveau.setText(com.trolltech.qt.core.QCoreApplication.translate("UIGestionFamiliers", "Niveau :", null));
    } // retranslateUi
