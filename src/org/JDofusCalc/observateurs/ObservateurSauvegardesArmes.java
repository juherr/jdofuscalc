...
/**
 * Observateur des évenements liés aux sauvegardes des armes.
 * 
 * @author PAPAYA Alexandre
 * @category Observateur
 * @version 1.0
 */
public interface ObservateurSauvegardesArmes extends EventListener
{
	/**
	 * Méthode invoquée lors de la sauvegarde d'une arme.
	 * 
	...
	/**
	 * Méthode invoquée lors de la création d'une arme.
	 * 
	 * @param typeArme - Type de l'arme.
	 * @param sauvegarde - Objet sauvegarde de l'arme. 
	 */
	...
	/**
	 * Méthode invoquée lors de la suppression d'une arme.
	 * 
	 * @param typeArme - Type de l'arme.
	 */
